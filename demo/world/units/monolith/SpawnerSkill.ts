...
export class SpawnerSkill extends AIUnitSkill {
    ...
    private readonly spawners: SpawnerEffect[] = [{
        key: 'spawner6', index: 6, parent: null, tile: vec2(3,1)
    }, {
        key: 'spawner7', index: 7, parent: null, tile: vec2(1,-1)
    }, {
        key: 'spawner8', index: 8, parent: null, tile: vec2(1,3)
    }, {
        key: 'spawner9', index: 9, parent: null, tile: vec2(-1,1)
    }]
    public use(source: AIUnit, target: vec2): Generator<ActionSignal> {
        this.mesh = source.mesh
        this.spawners.forEach(effect => effect.parent = source)
