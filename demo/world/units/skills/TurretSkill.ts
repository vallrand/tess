...
export class TurretSkill extends AIUnitSkill {
    ...
    private readonly turrets: TurretEffect[] = [{
        key: 'turret11', index: 10, context: this.context, parent: this
    }, {
        key: 'turret01', index: 12, context: this.context, parent: this
    }, {
        key: 'turret00', index: 14, context: this.context, parent: this
    }, {
        key: 'turret10', index: 16, context: this.context, parent: this
    }]
