...
export const mat4 = () => mat4.identity(new Float32Array(16) as any)
...
mat4.copy = (mat: mat4, out: mat4): mat4 => {
...
mat4.transpose = (mat: mat4, out: mat4): mat4 => {
    let temp = mat[1]; out[1] = mat[4]; out[4] = temp
    temp = mat[2]; out[2] = mat[8]; out[8] = temp
    temp = mat[3]; out[3] = mat[12]; out[12] = temp
    temp = mat[6]; out[6] = mat[9]; out[9] = temp
    temp = mat[7]; out[7] = mat[13]; out[13] = temp
    temp = mat[11]; out[11] = mat[14]; out[14] = temp
    if(out === mat) return out
    out[0] = mat[0]; out[5] = mat[5]; out[10] = mat[10]; out[15] = mat[15]
    return out
}

mat4.invert = (mat: mat4, out: mat4): mat4 => {
    ...
    det = det ? 1 / det : 0
    out[0] = (m11 * d11 - m12 * d10 + m13 * d09) * det
    out[1] = (m02 * d10 - m01 * d11 - m03 * d09) * det
    out[2] = (m31 * d05 - m32 * d04 + m33 * d03) * det
    out[3] = (m22 * d04 - m21 * d05 - m23 * d03) * det
    out[4] = (m12 * d08 - m10 * d11 - m13 * d07) * det
    out[5] = (m00 * d11 - m02 * d08 + m03 * d07) * det
    out[6] = (m32 * d02 - m30 * d05 - m33 * d01) * det
    out[7] = (m20 * d05 - m22 * d02 + m23 * d01) * det
    out[8] = (m10 * d10 - m11 * d08 + m13 * d06) * det
    out[9] = (m01 * d08 - m00 * d10 - m03 * d06) * det
    out[10] = (m30 * d04 - m31 * d02 + m33 * d00) * det
    out[11] = (m21 * d02 - m20 * d04 - m23 * d00) * det
    out[12] = (m11 * d07 - m10 * d09 - m12 * d06) * det
    out[13] = (m00 * d09 - m01 * d07 + m02 * d06) * det
    out[14] = (m31 * d01 - m30 * d03 - m32 * d00) * det
    out[15] = (m20 * d03 - m21 * d01 + m22 * d00) * det
    return out
}
...
mat4.perspective = (fovy: number, aspectRatio: number, znear: number, zfar: number, out: mat4): mat4 => {
    const f = 1.0 / Math.tan(fovy / 2), nf = 1 / (znear - zfar)
