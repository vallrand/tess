...
quat.HALF_N_X = quat.axisAngle(vec3.AXIS_X, -0.5 * Math.PI, quat())
quat.HALF_N_Y = quat.axisAngle(vec3.AXIS_Y, -0.5 * Math.PI, quat())
quat.HALF_N_Z = quat.axisAngle(vec3.AXIS_Z, -0.5 * Math.PI, quat())